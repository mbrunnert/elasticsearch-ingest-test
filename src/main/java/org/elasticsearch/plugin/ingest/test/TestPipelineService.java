 ...
 * @author mattias
 */
public class TestPipelineService extends BaseRestHandler {
    
    private static final String FIELD_EXPECTED_DOCS = "expected_docs";
    
    public TestPipelineService(final RestController controller) {
    ...
    protected RestChannelConsumer prepareRequest(RestRequest restRequest, NodeClient client) throws IOException {
        ...
        return channel -> {
            RestToXContentListener<SimulatePipelineResponse> ingestTestXContentListener = 
                    new TestPipelineXContentListener(channel, expectedDocs);
